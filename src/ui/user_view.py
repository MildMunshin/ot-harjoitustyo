...
class UserView:
    def __init__(self, root, handle_create_user, handle_show_login):
        ...
        ttk.Label(self._frame, text="Re-enter password").grid(row=3, column=0)
        self._password2_entry.grid(row=3, column=1)
    ...
    def _handle_create_user_click(self):
        ...
        self._handle_create_user(username, password, password2)
