...
class TestUpdateExercise(unittest.TestCase):
    ...
    def test_update_exercise(self):
        ...
        print(test_exercise[0].id)

        self.assertEqual(test_exercise[0].name, "Deadlift")

        self.exercise_service.update_exercise(test_exercise[0].id, test_exercise[0].day_id, "Pull-up", 4, 5, 95.0)
        updated_exercise = self.exercise_service.get_exercises_by_day(day_id)
        values = (updated_exercise[0].name, updated_exercise[0].sets, updated_exercise[0].reps, updated_exercise[0].weight)
        print(values)

        self.assertEqual(values, ("Pull-up", 4, 5, 95.0))